<%-- 
    Document   : jCloseBetKo
    Created on : 16.06.2021, 19:23:16
    Author     : zmugg
--%>
...
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
         <link href="styleCloseBet.css" rel="stylesheet" type="text/css"/>
     ...
     <body style="background-color: rgba(43,49,52,1)">
        ...
        <form action="./BetslyServlet" method="post">
            ...
            <span class="text2">Score:</span> <input class="input" type="text" name="scoreClose" value="" placeholder="0:0"/></div>
            <div class="btdiv">
