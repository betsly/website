    ...
    <body>
        <form action="./BetslyServlet" method="POST" onsubmit="return validateLogin()">
            <div id="Login">
                ...
                <div>
                    <span><input type="text" name="email" value="testUser2" placeholder="Email Adresse" id="Username"/></span>
                </div>
                <div id="event">
                ...
                <div>
                    <span><input type="text" name="password" value="testUser2" placeholder="Password" id="Passwort"/></span>
                </div>
                <div id="ID1633250">
                ...
                <div id="Primary_Button" class="Primary_Button">
                    ...
                    <div>
                        <span><input type="submit" value="Login" name="confirmLogin" id="Login_db" /></span>
                    </div>
                </div>
                <div id="Primary_Button_dc" class="Primary_Button">
                    <div id="Rounded_button_dd">
                        <svg class="Rectangle_1_de">
                        <rect id="Rectangle_1_de" rx="40" ry="40" x="0" y="0" width="262" height="80">
                        </rect>
                        </svg>
                        <svg class="Rectangle_2_df">
                        <rect id="Rectangle_2_df" rx="40" ry="40" x="0" y="0" width="262" height="80">
                        </rect>
                        </svg>
                    </div>
                    <div>
