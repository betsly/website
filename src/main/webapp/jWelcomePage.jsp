...
<html>
    <head>
        ...
        <link href="styleWelcome.css" rel="stylesheet" type="text/css"/>
...
<body style="background-color: rgba(43,49,52,1)">
    ...
    <p class="title">Willkommen ${username}!</p>
    <div id="divbt">    
    <div class="buttons"><input class="bt" id="bt" type="submit" value="show groups" name="showGroupsForm" /></div>
    <div class="buttons"><input class="bt" id="bt" type="submit" value="create group" name="createGroupForm" /></div>
    <div class="buttons"><input class="bt" id="bt" type="submit" value="join group" name="joinGroupForm" /></div>
    <div class="buttons"><input class="bt" id="bt" type="submit" value="Logout" name="logout" /></div></div>
