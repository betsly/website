...
<html>
    <head>
        ...
        <link href="styleCreateBet.css" rel="stylesheet" type="text/css"/>
    </head>
    <body style="background-color: rgba(43,49,52,1)">
        <form action="./BetslyServlet" method="POST">
             ...
             <div id="football">
                ...
                <p class="title">Wette erstellen</p>
                <div class="selectdiv">
            <select class="select" name="betType" onchange="submit()">
                <option value="group" ${betType.equals('ko') ? 'selected' : ''}>KO Phase</option>
                <option value="ko" ${betType.equals('group') ? 'selected' : ''}>Group Phase</option>
            </select></div>>
            <br>
            ...
            <div class="inputs">
                <div class="inputdiv"><input class="input" type="text" name="betName" placeholder="  Name" value=""/> </div>
                <div class="inputdiv"> <input class="input" type="text" name="country1" value="" placeholder=" Country1" list="countries_id"/> </div>
                <div class="inputdiv"><input class="input" type="text" name="country2" value="" placeholder="  Country2" list="countries_id"/> </div>
